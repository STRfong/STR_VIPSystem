...
urlpatterns = [
    ...
    path('project_list/', include([
        ...
        path('<int:project_id>/', include([
            ...
            path('participants/', include([
                     path('', ProjectParticipantsView.as_view(), name="project_participants"),
                     path('<int:participant_id>/', include([   #####檢查到這裡#####
                        path('remove/', views.remove_participant, name='remove_participant'),
                        path('send_email/', views.send_email, name="send_email"),
                     ])),
                 ])),
            path('invite_list/', InviteListView.as_view(), name="invite_list"),
            path('send_emails_list/', SendEmailListView.as_view(), name="send_emails_list"),
            path('update_participants/', views.update_participants, name="update_participants"), 
            path('remove_participant/<int:participant_id>/', views.remove_participant, name='remove_participant'),
        ])),
    ])),


    # path('project_list/<int:project_id>/update_participants/', views.update_participants, name="update_participants"),
    # path('project_list/<int:project_id>/participants/<int:participant_id>/remove/', views.remove_participant, name='remove_participant'),
    path('project_list/<int:project_id>/participants/<int:participant_id>/send_email/', views.send_email, name="send_email"),
    ...
    path('project_list/<int:project_id>/event_time/<int:event_time_id>/participants/<int:participant_id>/remove/', views.remove_participant_event_time, name='remove_participant_event_time'),
